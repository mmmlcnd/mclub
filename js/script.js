...
$(function(){
	...
	$(".gminiImage02").mouseover(function(){
		$("#showArea img").attr({src:"images/brandlogo600.png"});
	});
	
	$(".gminiImage03").mouseover(function(){
		$("#showArea img").attr({src:"images/aikirin600.png"});
	});
	
	$(".gminiImage04").mouseover(function(){
		$("#showArea img").attr({src:"images/banner600.png"});
	});
